...
reg = l2(0.001)
model = Sequential()   
model.add(Dense(64,input_shape=(106,),activation='relu',kernel_initializer=init))
...
model.add(Dropout(.25))
model.add(Dense(8,activation='relu',kernel_regularizer=reg,kernel_initializer=init))
model.add(Dropout(.25))
